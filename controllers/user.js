...
exports.login = async (req, res, next) => {
  try {
    ...
    res.status(200).json({
       userId: user._id, email: user.email, role: user.role, Firstname: user.firstname, Lastname: user.lastname, fonction:user.fonction, secteur:user.secteur, civilite:user.civilite,raisonsociale:user.raisonsociale, nomsociete: user.nomsociete, clientcode:user.clientcode,
      accessToken
    })
  } catch (error) {
