...
router.get('/', userController.allowIfLoggedin, userController.grantAccess('readOwn', 'carousel'), carouselController.getCarouselalldata);
...
router.put('/:id', userController.allowIfLoggedin, userController.grantAccess('updateAny', 'carousel'),carouselController.updateCarouseldata);
